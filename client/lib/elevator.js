Template.body.onRendered(function(){
    // Elevator.js open source code for easy to top scrolling (Can play music)
    ...
    // Auto scroll up functionality for Back to Top button
    elevator = new Elevator({
        element: document.querySelector('#toTop'),
        duration: 1000 // milliseconds
    });

    // Add tooltip to Back to Top button
